/*! \file BambookCore.h
    ...
    Copyright (C) 2009-2010 盛大网络 All right reserved\n
...
/*! 移动分类信息中指定分类到新的位置
    ...
    \param hCatalog     分类信息句柄
    \param uIndex       要移动的分类索引号
    \param uNewIndex    新的索引号位置
    \return             成功返回 BR_SUCC，如果索引超出范围返回 BR_OUT_OF_BOUNDS，其它错误返回错
                        误原因代码
*/
BB_RESULT 
...
/*! 从分类信息中的指定分类下移除指定的书籍
    ...
    \param hCatalog     分类信息句柄
    \param uIndex       要操作的分类索引号
    \param uBookIndex   要移除的书籍索引号
    \return             成功返回 BR_SUCC，如果索引超出范围返回 BR_OUT_OF_BOUNDS，其它错误返回错
                        误原因代码
*/
BB_RESULT 
